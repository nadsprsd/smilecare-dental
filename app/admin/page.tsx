      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-8">
        ...
        <div className="bg-white shadow-sm">
          <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="text-xs text-[#4A5568] bg-[#F4F7FA] px-3 py-2 border border-gray-200">
              Sorted by latest · Refresh page to reload
            </div>
          </div>
                  ...
                  {data.map((apt: any, idx: number) => (
                    <tr key={apt._id.toString()} className={`border-b border-gray-50 hover:bg-[#F4F7FA] transition-colors ${idx % 2 !== 0 ? "bg-[#FAFBFC]" : ""}`}>
                      ...
                      <td className="px-5 py-4 max-w-[160px]">
                        <span className="text-[#0D1117] font-medium text-xs leading-snug">{apt.service}</span>
                      </td>
        ...
        <div className="mt-6 text-center text-[#4A5568] text-xs">
          SmileCare Admin · Secure ·{" "}

      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div
          className="
            ...
            [&>ul]:text-gray-600 [&>ul]:mb-5 [&>ul]:pl-6 [&>ul]:list-disc [&>ul]:space-y-2
            [&>ol]:text-gray-600 [&>ol]:mb-5 [&>ol]:pl-6 [&>ol]:list-decimal [&>ol]:space-y-2
            [&>li]:leading-relaxed
            [&>strong]:text-[#0D1117] [&>strong]:font-semibold
            [&>blockquote]:border-l-4 [&>blockquote]:border-[#C9A96E] [&>blockquote]:pl-5
              [&>blockquote]:italic [&>blockquote]:text-gray-500 [&>blockquote]:my-6
      ...
      <div className="max-w-3xl mx-auto px-6 pb-16">
        <div className="bg-[#0D1117] rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-white/60 mb-6 text-sm">
            Free consultation at SmileCare, Tripunithura. No obligation.
          </p>

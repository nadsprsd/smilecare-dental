...
export default async function BlogPostPage(
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header */}
      <div className="bg-[#0D1117] py-16 text-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div
          className="
            ...
            [&>li]:leading-relaxed
            [&>a]:text-[#00A3E0] [&>a]:underline
            [&>strong]:text-[#0D1117] [&>strong]:font-semibold
            [&>blockquote]:border-l-4 [&>blockquote]:border-[#C9A96E]
              [&>blockquote]:pl-5 [&>blockquote]:italic [&>blockquote]:text-gray-500 [&>blockquote]:my-6
          "
      ...
      <div className="max-w-3xl mx-auto px-6 pb-16">
        <div className="bg-[#0D1117] rounded-2xl p-8 md:p-10 text-center text-white">
          <h3 className="text-xl font-bold mb-2" style={{ fontFamily: "Georgia, serif" }}>
            Have Questions? Talk to Our Dentist.
          </h3>
          <p className="text-white/60 mb-6 text-sm">
            Free consultation at SmileCare, Tripunithura.
          </p>

...
const SOCIAL = [
  {
    name: "Facebook",
    href: "https://facebook.com/veecaredentalclinic",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/veecaredentalclinic",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/@veecaredentalclinic",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Google Maps",
    href: "https://maps.google.com/?q=Vee Care+Dental+Tripunithura",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className="bg-[#0D1117] text-white">
        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                ...
                <div className="text-[10px] text-[#C1583B] font-bold tracking-widest uppercase">Dental Clinic</div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                {SOCIAL.map(s => (
                  <a
                    ...
                    aria-label={s.name}
                    className="w-9 h-9 bg-white/5 hover:bg-[#C1583B] border border-white/10 hover:border-[#C1583B] flex items-center justify-center text-white/60 hover:text-white transition-all duration-200 rounded-lg"
                    title={s.name}
                  >
                    {s.icon}
                  </a>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/55 text-sm">
              ...
              <li className="flex gap-3">
                <Clock size={16} className="shrink-0 text-[#C1583B]" />
                <span>Mon–Sat: 9AM–8PM (Evening OP)<br /><span className="text-white/50">Sunday: 9AM–2PM</span></span>
              </li>
            </ul>
            ...
            <Link
              href="/appointment"
              className="inline-block mt-6 bg-[#C1583B] hover:bg-[#b8935a] text-white text-sm font-semibold px-5 py-2.5 transition-colors"
            >
              Book Appointment →
            </Link>
          </div>
      ...
      <div className="border-t border-white/8 py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-white/30 text-xs">
          <p>© {new Date().getFullYear()} Vee Care Dental Clinic, Tripunithura. All rights reserved.</p>
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#C1583B] hover:text-white transition-colors"
            >
              BizGrowOnline
            </a>
          </p>
